...
foreign box2d
{
    ...
    world_query_aabb :: proc(world_id: World_ID, fcn: Query_Result_Fcn, aabb: AABB, filter: Query_Filter, context_: rawptr) ---
    ...
    b2Body_ApplyForce :: proc(body_id: Body_ID, force, point: Vec2, wake: bool) ---
    ...
    Body_GetMassData :: proc(body_id: Body_ID) -> Mass_Data ---
    
    // Adjust the linear damping. Normally this is set in b2BodyDef before creation.
    @(link_name="b2Body_SetLinearDamping")
    Body_SetLinearDamping :: proc(body_id: Body_ID, linear_damping: f32) ---
    
    // Get the current linear damping.
    @(link_name="b2Body_GetLinearDamping")
    Body_GetLinearDamping :: proc(body_id: Body_ID) -> f32 ---
    
    // Adjust the angular damping. Normally this is set in b2BodyDef before creation.
    @(link_name="b2Body_SetAngularDamping")
    Body_SetAngularDamping :: proc(body_id: Body_ID, angular_damping: f32) ---
    
    // Get the current angular damping.
    @(link_name="b2Body_GetAngularDamping")
    Body_GetAngularDamping :: proc(body_id: Body_ID) -> f32 ---
    
    // Adjust the gravity scale. Normally this is set in b2BodyDef before creation.
    @(link_name="b2Body_SetGravityScale")
    Body_SetGravityScale :: proc(body_id: Body_ID, gravity_scale: f32) ---
    
    // Get the current gravity scale.
    @(link_name="b2Body_GetGravityScale")
    Body_GetGravityScale :: proc(body_id: Body_ID) -> f32 ---
    ...
    b2Shape_GetCircle :: proc(shape_id: Shape_ID) -> ^Circle ---
    ...
    shape_get_contact_data :: proc(shape_id: Shape_ID, contactData: ^Contact_Data, capacity: i32) -> i32 ---
    ...
    motor_joint_get_constraint_force :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> Vec2 ---
    
    // Get the current constraint torque for a motor joint
    @(link_name="b2MotorJoint_GetConstraintTorque")
    motor_joint_get_constraint_torque :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> f32 ---
    ...
    prismatic_joint_get_motor_force :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> f32 ---
    ...
    prismatic_joint_get_constraint_force :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> Vec2 ---
    
    // Get the current constraint torque for a prismatic joint
    @(link_name="b2PrismaticJoint_GetConstraintTorque")
    prismatic_joint_get_constraint_torque :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> f32 ---
    ...
    revolute_joint_get_constraint_force :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> Vec2 ---

    // Get the current constraint torque for a revolute joint
    @(link_name="b2RevoluteJoint_GetConstraintTorque")
    revolute_joint_get_constraint_torque :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> f32 ---
    
    // Set the wheel joint stiffness
    @(link_name="b2WheelJoint_SetStiffness")
    wheel_joint_set_stiffness :: proc(joint_id: Joint_ID, stiffness: f32) ---
    
    // Set the wheel joint damping
    @(link_name="b2WheelJoint_SetDamping")
    wheel_joint_set_damping :: proc(joint_id: Joint_ID, damping: f32) ---
    ...
    wheel_joint_get_motor_torque :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> f32 ---
    ...
    wheel_joint_get_constraint_force :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> Vec2 ---
    
    // Get the current wheel joint constraint torque
    @(link_name="b2WheelJoint_GetConstraintTorque")
    wheel_joint_get_constraint_torque :: proc(joint_id: Joint_ID, inverse_time_step: f32) -> f32 ---
    ...
    shape_cast :: proc(input: ^Shape_Cast_Pair_Input) -> Ray_Cast_Output ---
    ...
    collide_smooth_segment_and_circle :: proc(segment_a: ^Smooth_Segment, xf_a: Transform, circle_b: ^Circle, xf_b: Transform) -> Manifold ---

    // Compute the collision manifold between an segment and a capsule.
    @(link_name="b2CollideSmoothSegmentAndCapsule")
    collide_smooth_segment_and_capsule :: proc(segment_a: ^Smooth_Segment, xf_a: Transform, capsule_b: ^Capsule, xf_b: Transform, cache: ^Distance_Cache) -> Manifold ---

    // Compute the collision manifold between a smooth segment and a rounded polygon.
    @(link_name="b2CollideSmoothSegmentAndPolygon")
    collide_smooth_segment_and_polygon :: proc(segment_a: ^Smooth_Segment, xf_a: Transform, polygon_b: ^Polygon, xf_b: Transform, cache: ^Distance_Cache) -> Manifold ---
